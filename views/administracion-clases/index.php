                        ...
                        <table class="w-full text-sm text-left text-gray-500 ">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50  ">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 whitespace-nowrap">Objetivo</th>
                            ...
                            <tbody>
                                <tr class="border-b odd:bg-gray-50 even:bg-white">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">Sesión 01</th>
                                    <td class="px-4 py-3">Diagnóstico Inicial	</td>
                                    <td class="px-4 py-3">Define la competencia inicial del usuario.	</td>
                            
                            

                                    <td class="px-4 py-3 flex items-center gap-2 justify-start">
                                        <button data-modal-target="edit-class-modal" data-modal-toggle="edit-class-modal"
                                            ...
                                            <svg class=" h-5 w-5 " stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"><g id="Edit"><g><path d="M3.548,20.938h16.9a.5.5,0,0,0,0-1H3.548a.5.5,0,0,0,0,1Z"></path><path d="M9.71,17.18a2.587,2.587,0,0,0,1.12-.65l9.54-9.54a1.75,1.75,0,0,0,0-2.47l-.94-.93a1.788,1.788,0,0,0-2.47,0L7.42,13.12a2.473,2.473,0,0,0-.64,1.12L6.04,17a.737.737,0,0,0,.19.72.767.767,0,0,0,.53.22Zm.41-1.36a1.468,1.468,0,0,1-.67.39l-.97.26-1-1,.26-.97a1.521,1.521,0,0,1,.39-.67l.38-.37,1.99,1.99Zm1.09-1.08L9.22,12.75l6.73-6.73,1.99,1.99Zm8.45-8.45L18.65,7.3,16.66,5.31l1.01-1.02a.748.748,0,0,1,1.06,0l.93.94A.754.754,0,0,1,19.66,6.29Z"></path></g></g></svg>
                                      </button>
                                        ...
                                        <button
                                            ...
                                            <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                                        </button>
        ...
        <form class="relative p-4 w-full max-w-xl max-h-full">
            ...
            <div class="relative bg-white rounded-t-lg shadow ">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class=" w-full">
                    <div class="mb-5">
                    <label for="nombre" min="0" class="block mb-2 text-sm font-medium text-gray-900 ">Nombre</label>
                  ...
                  <div class="mb-5">
                    <label for="titulo" min="0" class="block mb-2 text-sm font-medium text-gray-900 ">Título</label>
                    <input type="number"  id="titulo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                  </div>
                  <div class="mb-5">
                    <label for="titulo" min="0" class="block mb-2 text-sm font-medium text-gray-900 ">Título</label>
                    <input type="number"  id="titulo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                  ...
                  <div class="mb-5">
                    ...
                    <textarea  required rows="5" id="objetivo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Objetivo"></textarea>
                  </div>
