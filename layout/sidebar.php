<aside
    class=" max-w-[220px] 2xl:max-w-[270px] xl:bg-transparent  ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto r border-0  p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 ">
    <div class="h-19.5 bg-white rounded-l-2xl rounded-tr-2xl ">
                ...
                <a href="#" class=" w-full group transition duration-300 cursor-pointer flex gap-0 bg-white ">
                    ...
                    <div class=" flex-1 w-full flex flex-col justify-center px-2">
                        <div
                            ...
                            <div
                                class="transition duration-300 group-hover:bg-blue-600 group-hover:bg-opacity-90 p-2 rounded-full">
            ...
            <li class=" w-full  ">
                ...
                <div class=" flex-1 w-full flex flex-col justify-center px-2">
                    <div
                        ...
                        <div
                            class="transition duration-300 group-hover:bg-red-600 group-hover:bg-opacity-90 p-2 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class=" text-black group-hover:text-white  duration-500  w-6 h-6 group-hover:h-7 group-hover:w-7 transition-all "
                                viewBox="0 0 24 24">
